...
//	number of bytes actually read -- if the open file isn't long enough, 
//	or if it is an I/O device, and there aren't enough characters to 
...
//	current owner and belongs to currentThread's process.
//----------------------------------------------------------------------
...
//	belongs to currentThread's process.
//----------------------------------------------------------------------
...
//	belongs to the currentThread's process.
//----------------------------------------------------------------------
